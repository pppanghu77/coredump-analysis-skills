#!/usr/bin/env python3
"""dde-polkit-agent cluster-level automatic fix plans and actions."""
...
def build_fix_plan_for_cluster(cluster: CrashCluster) -> FixPlan:
    # All known dde-polkit-agent crash patterns occur in system libraries
    # (Qt XCB / libX11), with no safe application-layer fix point.
    ...
    return FixPlan(
        ...
        root_cause=(
            ...
            "dde-polkit-agent 的可修复崩溃均发生在系统库（Qt XCB / libX11）中，"
            "应用层没有安全的直接修复点。"
        ),
